...
## Dinámica para resolver los practicos.

1. Conseguir el repositorio de la materia en GitHub.

2. Clonar el repositorio en tu computadora.
3. Crear una rama nueva para tu trabajo.
4. Hacer los cambios necesarios para resolver el práctico.
5. Revisar el estado de los cambios.
6. Agregar los cambios al staging area.
7. Crear un commit con un mensaje descriptivo.
8. Subir la rama a GitHub.
9.  Abrir un pull request para que revisen tu trabajo.
10. Esperar la revisión y hacer ajustes si es necesario.
11. Una vez aprobado, se fusiona el pull request con la rama principal.